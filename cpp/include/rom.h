...
/* ROM tables */
extern long Base18[SubFrameSize / SPACING];
extern float ppvq[ACBGainSize];
extern float gnvq_8[maxFCBGainSize];
extern float gnvq_4[maxFCBGainSize];

extern short nsize8[2];
extern short lognsize8[2];
extern short nsub8[2];
extern float rnd_delay[NoOfSubFrames + 2];
...
extern float lsptab22[1792];
extern float lsptab28[2176];

extern float Logqtbl[256 * 3];
