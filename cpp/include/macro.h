...
#define OneDivPI2 0.15915494    /* 1/(2*PI) */
#define FALSE 0
#define TRUE 1
...
#define MIN_LSP_SEP   (0.05 * OneDivPI2) /* (64 Hz) Minimum LSP separation */
#define GAMMA1        0.9   /* Weighting filter fraction coefficient */
...
#define BLFREQ       0.9    /* Cut-off filter frequency         */
