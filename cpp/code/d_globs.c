...
float   PitchMemoryD[ACBMemSize + SubFrameSize + EXTRA];
float   PitchMemoryD_back[ACBMemSize];
float   DECspeech[SubFrameSize];/* Output decoder speech           */
float   DECspeechPF[SubFrameSize];	/* Output decoder speech with post filter */
